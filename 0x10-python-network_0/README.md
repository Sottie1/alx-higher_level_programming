...
In this networking prus types
of HTTP headers. In the process, I learneoject, I used `curl` in Bash scripts to send variod about how URL's work, domain names,
the many diftus codes, and
how to utilize cookies.

Task six wferent HTTP request/repsonse header fields and staas an algorithm challenge separate from the overall project theme
completed in Python.
